...
export default function Home() {
  ...
  // useEffect(() => {
  //   fetch("http://localhost:2000/api/test")
  ...
  return (
    <div>
      ...
      <div className="flex items-center flex-col h-screen bg-[#00000075]">
        ...
        <div className="bg-[#ffffff95] py-3 px-5 cursor-pointer rounded-lg hover:bg-[#9C814D95] group transition ease-in-out duration-500 mt-5">
          <p className="group-hover:text-white">RSVP Now</p>
        </div>

        <img
          src="background2.jpg"
          className="absolute z-[-10] w-screen max-h-full object-cover"
        />
      </div>
    </div>
  );
